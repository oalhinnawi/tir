    ...
    render(){
        ...
        <React.Fragment>
            ...
            <container>
                ...
                <Form.Label>Select Date to Analyze(MMDDYYY)</Form.Label>
                <div className ='date_input'>
                    <br></br>
                    <br></br>
                <Form.Control type="date" placeholder="(MMDDYYYY)" name="date" value={this.state.value} onChange={this.handleChange}/>
                </div>
